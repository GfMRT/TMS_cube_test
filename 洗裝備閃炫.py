...
# 閃炫
equip = ['帽', '衣', '褲', '手', '鞋', '披風,腰帶,肩膀', '飾']
equip_A_STR = [0.0794, 0.0685, 0.0794, 0.0746, 0.0794, 0.0847, 0.098]
equip_A_all = [0.0635, 0.0548, 0.0635, 0.0597, 0.0635, 0.0678, 0.0784]
...
equip_CD1 = 0.0566
equip_CD2 = 0.0377
skill_head_door_A = 0.0635
invincible_clothes_A = 0.0548
skill_pant_fire_A = 0.0635
skill_glove_eye_A = 0.0597
skill_shoe_speed_A = 0.0635
